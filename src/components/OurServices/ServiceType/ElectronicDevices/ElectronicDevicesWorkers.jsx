...
const ElectronicDevicesWorkers = () => {
  ...
  useEffect(() => {
    if (category === "washbasin") {
      setHeading("Wash Basin");
    } else if (category === "ac") {
      setHeading("Air Condition (AC)");
    } else if (category === "refrigerator") {
      setHeading("Refrigerator");
    } else if (category === "washingmachine") {
      setHeading("Washing Machine.");
    } else if (category === "iron") {
      setHeading("Iron Services");
    } else if (category === "vacuumcleaner") {
      setHeading("Vaccume Cleaner Service");
    } 
  }, []);
...
export default ElectronicDevicesWorkers;
