...
const PlumbingWorkers = () => {
  ...
  useEffect(() => {
    if (category === "washbasin") {
      setHeading("Installation and repair of wash basins.");
    } 
    else if (category === "tapfaucets") {
      setHeading("Installation and maintenance of taps and faucets.");
    } 
    else if (category === "toilet") {
      setHeading("Repair and maintenance of toilet systems.");
    } 
    else if (category === "watertank") {
      setHeading("Installation and repair of water tanks.");
    } 
    else if (category === "blockages") {
      setHeading("Clearing blockages in plumbing systems.");
    } 
    else if (category === "wholehouseplumbing") {
      setHeading("Complete plumbing solutions for entire houses.");
    } 
  }, []);
...
export default PlumbingWorkers;
