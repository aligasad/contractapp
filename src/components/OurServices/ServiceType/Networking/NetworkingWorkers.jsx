...
const NetworkingWorkers = () => {
  ...
  // For heading - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  useEffect(() => {
    if (category === "gamingsetup") {
      setHeading("Gaming & Setup Service");
    } else if (category === "computerlaptop") {
      setHeading("Computer And Laptop Repairing");
    } else if (category === "ittechnician") {
      setHeading("IT Technician Service");
    } 
  }, []);
...
export default NetworkingWorkers;
